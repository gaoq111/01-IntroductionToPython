...
hello = rg.SimpleTurtle('turtle')
hello.pen = rg.Pen('blue',20)
hello.go_to(rg.Point(0,200))
hello.pen_up()
hello.go_to(rg.Point(100,-40))
hello.pen_down()
hello.pen=rg.Pen('green',10)
hello.go_to(rg.Point(100,-190))
